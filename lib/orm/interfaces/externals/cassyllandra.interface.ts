...
export interface BaseModel<T = any> {
  ...
  findOne(query: FindQuery<T>, options: { return_query?: boolean } & FindQueryOptionsStatic<T>): string;
  ...
  findOneAsync(query: FindQuery<T>, options: FindQueryOptionsStatic<T> & { raw?: boolean }): Promise<T>;

  findOneAsync(query: FindQuery<T>, options?: FindQueryOptionsStatic<T>): Promise<BaseModelStatic<T>>;

  find(query: FindQuery<T>, options?: { return_query?: boolean } & FindQueryOptionsStatic<T>): string;
  ...
  findAsync(query: FindQuery<T>, options: FindQueryOptionsStatic<T> & { raw?: boolean }): Promise<T[]>;
  ...
  update(
    ...
    options: { return_query?: boolean } & UpdateOptionsStatic<T>,
  ): any;
  ...
  delete(query: FindQuery<T>, options: { return_query?: boolean } & DeleteOptionsStatic): any;
  ...
  execute_queryAsync(query: string, params: any[]): Promise<any>;

  execute_batch(queries: BatchQuery[], callback?: (err: Error) => void): void;

  execute_batchAsync(queries: BatchQuery[]): Promise<any>;
...
export interface BaseModelStatic<T> {
  save(options: { return_query: true } & SaveOptionsStatic): any;
  ...
  delete(options: { return_query: true } & DeleteOptionsStatic): any;
